The project is a fork of [mobile-ffmpeg](https://github.com/tanersener/mobile-ffmpeg). It only supports limited processing of wav/pcm and mp3. If you want full features, please refer to the original project.
